...
（头 77cbd176，2026-09-21）；出口门第 1–6 项达成，第 7 项（真机配对 A/B 热窗口）与第 8 项
（三个强制性能数）尚未正式采集，故 P6 记为「实现完成、出口性能/设备数待补」，未宣布收官**。

**改后**：`P6 已收官（2026-09-22）`：全部包已落地（头 `77cbd176`，2026-09-21），出口门第 1–6 项此前已达成；
...
- **状态列**：`⏳ 全部包已落地（2026-09-21，头 77cbd176）；出口门 1–6 达成，7/8 待采` →
