...
> paired runs have passed. See [`P5F-WIRE-COMPLETENESS.md`](../p5f/P5F-WIRE-COMPLETENESS.md),
> the [closing review](../p5f/close-review.md) and [device report](../p5f/device-report.md).
>
...
[fs report](../p5f/fs-report.md) records the full census, lifecycle rules and red-once evidence.
