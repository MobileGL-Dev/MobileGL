...
- 库：`/data/local/tmp/mgcts/libMobileGL.so` = p7w1 APK 的 arm64 库，stamp **`p7w1-9be62cbc`**（wave 0 之前的 monolith Magma；`../00-session/apk.sha256`；`deploy/IDENTITY.txt`）。
