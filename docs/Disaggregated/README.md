...
| `P5F-WIRE-COMPLETENESS.md` | P5f 计划：`gPipeInputs` 是什么、拆进程后它怎样；阻碍跨进程的完整清单（`BARRIER_PULLED` 15 字段、Magma、EGL 控制面、静态量、豁免 scope、反向通道）；双块演练机制与出口门 |
