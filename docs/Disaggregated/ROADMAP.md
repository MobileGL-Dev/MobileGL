...
> **2026-09-24**：P0 到 P7 已完成；当前阶段 **P12**（server 自己开窗口上屏）功能已实现、待验收。每个阶段的计划、验收结果、实测与报告在 `notes/<阶段>/`（点阶段名进入）。
...
| [**P12**](notes/p12/README.md) | **server 自己开窗口上屏，client 不需要窗口** | **进行中**：已实现，待复测与验收 |
