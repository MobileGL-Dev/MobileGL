...
#undef MGR_COUNT_ONE
        ...
        // t2: BeginTransformFeedback, EndTransformFeedback, PauseTransformFeedback,
        // ResumeTransformFeedback, BindTransformFeedback, PatchParameteri.
        ...
        // 64 at the P5b contract commit, minus the six t2 flipped. CONTRACT-P5.md §7's number
        // is the one above, not this one; this is the arithmetic after t2 and it moves again
        // for every package that lands.
        static_assert(kUnmigratedSlots == 58, "class C is 58 slots after t2's six");
